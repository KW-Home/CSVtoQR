...
Public Class Class_DS
    ...
    Private Function DT_Shema() As DataTable
        ...
        With DT
            ...
            .Columns.Add(New DataColumn With {.ColumnName = "DPI", .DataType = GetType(Integer)})
            .Columns.Add(New DataColumn With {.ColumnName = "DIN", .DataType = GetType(String)})
            .Columns.Add(New DataColumn With {.ColumnName = "PaperHeight", .DataType = GetType(Double)})
            .Columns.Add(New DataColumn With {.ColumnName = "PaperWidth", .DataType = GetType(Double)})
            .Columns.Add(New DataColumn With {.ColumnName = "PaperBorderLeft", .DataType = GetType(Double)})
            .Columns.Add(New DataColumn With {.ColumnName = "PaperBorderRight", .DataType = GetType(Double)})
            .Columns.Add(New DataColumn With {.ColumnName = "PaperBorderTop", .DataType = GetType(Double)})
            .Columns.Add(New DataColumn With {.ColumnName = "PaperBorderBottom", .DataType = GetType(Double)})
            .Columns.Add(New DataColumn With {.ColumnName = "CardBorderLeft", .DataType = GetType(Double)})
            .Columns.Add(New DataColumn With {.ColumnName = "CardBorderRight", .DataType = GetType(Double)})
            .Columns.Add(New DataColumn With {.ColumnName = "CardBorderTop", .DataType = GetType(Double)})
            .Columns.Add(New DataColumn With {.ColumnName = "CardBorderBottom", .DataType = GetType(Double)})
            .Columns.Add(New DataColumn With {.ColumnName = "SeparatorZeileAnzahl", .DataType = GetType(Integer)})
            .Columns.Add(New DataColumn With {.ColumnName = "SeparatorZeileWert", .DataType = GetType(Double)})
            .Columns.Add(New DataColumn With {.ColumnName = "SeparatorSpalteAnzahl", .DataType = GetType(Integer)})
            .Columns.Add(New DataColumn With {.ColumnName = "SeparatorSpalteWert", .DataType = GetType(Double)})
